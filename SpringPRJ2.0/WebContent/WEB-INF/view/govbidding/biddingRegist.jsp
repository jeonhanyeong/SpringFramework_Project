<%@ page import="poly.dto.GovBiddingDTO" %>
            ...
            <div class="main_menu" id="mainNav">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="/resource/img/logo-2.png" alt=""><img src="/resource/img/logo-2.png" alt=""></a>
            ...
            <div class="container">
                <div class="banner_content">
                    <div class="comment-form" style="margin-top: 15%;">
                        <h3 style="text-align: left; color: black; text-align:center">정부사업신청 등록</h3>
                        ...
                        <form name='frm' method="post" action="InsertGovBoard.do">
                              ...
                              <div class="form-group form-inline">
                                <div class="form-group col-lg-6 col-md-6 name">
                                    <h4 style="color: black;">사업계획서</h4>
                                  <input type="text" class="form-control" id="name" name="business_plan" placeholder="사업계획서" onfocus="this.placeholder = ''" onblur="this.placeholder = '사업계획서'">
                                </div>
