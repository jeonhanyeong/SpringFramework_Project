<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="poly.service.impl.PriboardService" %>
<%@ page import="poly.dto.*" %>
<%@ page import="poly.service.*" %>
...
-->
<%
	List <PriboardDTO> priList = (List<PriboardDTO>)request.getAttribute("pList");
	PriboardDTO pb;
%>
<html lang="en">
            ...
            <div class="container">
                <div class="banner_content">
                    <div class="comment-form" style="margin-top: 15%;">
                        ...
                        <form action="/privateBoardInsert.do" method="post">
                        
                            <h3 style="color: black;">사업명</h3>
                                <div class="form-group col-lg-12 col-md-12 name">
                                    <input type="text" class="form-control" id="name" name="pri_business_title" placeholder="사업명"
                            ...
                            <div class="form-group form-inline">
                                ...
                                <div class="form-group col-lg-6 col-md-6 name">
                                  ...
                                  <input type="text" class="form-control" id="name" name="pri_business_start_date" placeholder="사업시작날짜" onfocus="this.placeholder = ''" onblur="this.placeholder = '사업시작날짜'">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 email">
                                    <h4 style="color: black;">사업종료날짜</h4>
                                  <input type="text" class="form-control" id="email" name="pri_business_end_date" placeholder="사업종료날짜" onfocus="this.placeholder = ''" onblur="this.placeholder = '사업종료날짜'">
                                </div>										
                              </div>
                              ...
                              <div class="form-group form-inline">
                                <div class="form-group col-lg-6 col-md-6 name">
                                  ...
                                  <input type="text" class="form-control" id="name" name="pri_eaof" placeholder="사업추정액" onfocus="this.placeholder = ''" onblur="this.placeholder = '사업추정액'">
                                </div>
                                <div class="form-group col-lg-6 col-md-6 email">
                                    <h4 style="color: black;">공고기한</h4>
                                  <input type="text" class="form-control" id="email" name="pri_announced" placeholder="공고기한" onfocus="this.placeholder = ''" onblur="this.placeholder = '공고기한'">
                                </div>										
                              </div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mb-10" rows="10" name="pri_business_details" placeholder="사업내용"
                            ...
                            <input type="submit" class="primary-btn submit_btn" value="제출하기">
                        </form>
                    </div>
                </div>
            </div>
