...
<html lang="en">
	...
	<!-- 서비스 메소드 호출 -->
<%
	/*  session.setArrtibute("SESSTION_USER_ID","USER01");*/
	List <PriboardDTO> priList = (List<PriboardDTO>)request.getAttribute("pList");
	String pNum = request.getParameter("page");	//페이징
%>
...
<head> 
    ...
    <link rel="stylesheet" href="/resource/css/privateBoardTable.css">
...
<body>
 ...
 <!--================Header Menu Area =================-->
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        ...
                        <a href="single-blog.html">민간사업 공고게시판</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog_area single-post-area p_120" id="table_section">
        ...
        <h2 id="board_head">민간사업 공고게시판</h2>
        ...
        <ul class="blog_meta list" id="board_write">
            ...
            <a class="banner_btn" href="privateBoardRegist.do" style="width:30%; line-height: 30px;">글 작성하기</a>
            </div>
...
<%--             <tbody>
				...
				<% } else { %>
                <% for( PriboardDTO pb : priList) { %>
                <tr>
                    <th scope="row" href="/privateBoardDetail?leid="<%=pb.getPri_business_board_no() %> 
                    title=<%= pb.getPri_business_title() %> onclick="">
                    <%= pb.getPri_business_board_no() %></th>
                    <td><%= pb.getPri_business_title() %></td>
                    <td><%= pb.getPri_registration_date() %></td>
                    <td><%= pb.getPri_enterprise_name() %></td>
                </tr>
                <% }
                }
                %>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row"><%= pb.getPri_business_board_no() %></th>
                    <td><a href="privateBoardDetail.do?leid=<%= pb.getPri_business_board_no() %>" title=<%= pb.getPri_business_title() %>><%= pb.getPri_business_title() %></a></td>
                    <td><%= pb.getPri_registration_date() %></td>
                    <td><%= pb.getPri_enterprise_name() %></td>
                </tr>
                <% }
