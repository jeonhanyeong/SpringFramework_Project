...
<body>
    ...
    <div class="join-wrap" style="min-height:500px;">
        <div class="join-html">
            <input id="tab" type="radio" name="tab" class="private" checked><label for="tab" class="tab">비밀번호 변경</label>
            <div class="join-form">
                ...
                <div class="group">
                    ...
                    <div class="group">
                        <label for="pass" class="label">변경 비밀번호</label>
                        <input id="pass" type="password" class="input" data-type="password">
                    </div>
                    <div class="group">
                        <label for="repw" class="label">변경 비밀번호 재확인</label>
                        <input id="repw" type="password" class="input" data-type="password">
                    </div>
                    <div class="group">
                        <input type="button" class="button" onclick="location.href='login.html'" value="비밀번호 변경">
                    </div>
        </div>
        </div>
    </div>
