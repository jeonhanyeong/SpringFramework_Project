...
<body>
    ...
    <div class="join-wrap">
        <div class="join-html">
            <input id="tab" type="radio" name="tab" class="land" checked><label for="tab" class="tab">원예/조경기업 회원가입</label>
            <div class="join-form">
                <div class="land-htm">
                    <div class="group">
                    ...
                    <div class="group">
                        <label for="com" class="label">기업 명</label>
                        <input id="com" type="name" class="input">
                    </div>
                    <div class="group">
                    ...
                    <div class="group">
                        <label for="no" class="label">사업자 등록번호</label>
                        <input id="no" type="text" class="input">
                    </div>
                    <div class="group">
                    ...
                    <div class="group">
                        <input type="button" class="button" onclick="location.href='index.jsp'" value="회원가입">
                    </div>
        </div>
        </div>
    </div>
