...
<head>
    ...
    <link href="/resource/skin/shop/basic/css/style.css" rel="stylesheet">
 ...
 <!--================Header Menu Area =================-->
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <div class="page_link">
                        ...
                        <a href="single-blog.html">진행현황 게시판</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="blog_area single-post-area p_120" id="table_section" ;>
        ...
        <ul class="blog_meta list" id="board_write">
            ...
            <a class="banner_btn" href="#" style="width:30%; line-height: 30px;">글 작성하기</a>
            </div>
