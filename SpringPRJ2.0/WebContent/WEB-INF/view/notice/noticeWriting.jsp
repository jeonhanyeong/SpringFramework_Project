<%@ page language="java" contentType="te n/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	...
	<section class="blog_area single-post-area p_120">
		<div class="container">
			<div class="comment-form">
				<h4 style="font-size: 22px;">공지글 작성</h4>
				<form>
					<div class="form-group">
						<input type="text" class="form-control" id="subject" placeholder="제목" onfocus="this.placeholder = ''" onblur="this.placeholder = '제목'">
					</div>
					<div class="form-group">
						<textarea class="form-control mb-10" rows="10" name="message" placeholder="내용" onfocus="this.placeholder = ''" onblur="this.placeholder = '내용'" required=""></textarea>
					</div>
					<a href="notice.do" class="primary-btn submit_btn">작성하기</a>
				</form>
			</div>
		</div>
	</section>
